        ...
        messages: [
          {
            ...
            content: `You are a location analytics expert. Always return analysis in this exact JSON structure:
            {
              ...
              "analysis": {
                "demographic_profile": "One sentence description",
                "lifestyle_trends": "One sentence description",
                "relevant_industries": "One sentence description",
                "physical_characteristics": "One sentence description",
                "type_of_center": "One sentence description",
                "nearby_businesses": "One sentence description"
              }
            }`
          },
          {
